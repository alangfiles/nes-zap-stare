...
;
; if((circle_y_speed < 0x8000) && (circle_y_speed > 0x0400)) circle_y_speed = 0x0400;
;
L00DA:	ldx     _circle_y_speed+1
	cpx     #$80
	bcs     L00DB
	lda     _circle_y_speed
	cmp     #$01
...
L00DB:	lda     _circle_x_speed
	...
	sta     _circle_x+1
;
; if(circle_x >= 0xf000) circle_active = 0;
;
	lda     _circle_x
	cmp     #$00
	lda     _circle_x+1
...
L00E5:	lda     _circle_y_speed
	...
	sta     _circle_y+1
;
; if(circle_y >= 0xe000) circle_active = 0;
;
	lda     _circle_y
	cmp     #$00
	lda     _circle_y+1
